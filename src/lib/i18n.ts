export const translations = {
  en: {
    ...
    habitMatrix: "Habit Matrix",
    aiHabitCoach: "AI Habit Coach Insights",
    scheduleBuilder: "Schedule Builder",
    generatePlan: "Generate Ideal Plan",
  ...
  hi: {
    ...
    habitMatrix: "आदत मैट्रिक्स",
    aiHabitCoach: "एआई हैबिट कोच इनसाइट्स",
    scheduleBuilder: "शेड्यूल बिल्डर",
    generatePlan: "आदर्श योजना बनाएं",
  ...
  es: {
    ...
    habitMatrix: "Matriz de Hábitos",
    aiHabitCoach: "Perspectivas del Coach de Hábitos de IA",
    scheduleBuilder: "Generador de Horarios",
    generatePlan: "Generar Plan Ideal",
